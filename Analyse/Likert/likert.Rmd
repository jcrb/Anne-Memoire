...
# Ajout d'une colonne SEP8 au fichier lk.av (SEP validé)
...
summary(lk.ap$SEP8)
sd(lk.ap$SEP8)
hist(lk.ap$SEP8, xlab = "SEP 8", ylab = "Fréquence", main = "Histogramme des scores de Likert après(8 items)")

# analyse du SEP12

summary(lk.ap$SEP12)
sd(lk.ap$SEP12)
hist(lk.ap$SEP12, xlab = "SEP 12", ylab = "Fréquence", main = "Histogramme des scores de Likert après (12 items)")

# comparaisons des groupes avec et sans prébriefing
t.test(SEP8 ~ PREB, data = lk.ap)
t.test(SEP12 ~ PREB, data = lk.ap)
...
# SEP 12
t <- t.test(lk.av$SEP12, lk.ap$SEP12)
```
...
# SEP 8
t <- t.test(lk.av$SEP8, lk.ap$SEP8)
```
- le score SEP8 est passé de `r t$estimate[1]` avant la formation à `r t$estimate[2]` après.
...
t.test(lk.av$SEP8[lk.av$PREB == "O"], lk.ap$SEP8[lk.ap$PREB == "O"])
# avant sans prébriefing
t.test(lk.av$SEP8[lk.av$PREB == "N"], lk.ap$SEP8[lk.ap$PREB == "N"])
# après avec prebriefing
t.test(lk.av$SEP12[lk.av$PREB == "O"], lk.ap$SEP12[lk.ap$PREB == "O"])
# après sans prébriefing
t.test(lk.av$SEP12[lk.av$PREB == "N"], lk.ap$SEP12[lk.ap$PREB == "N"])
